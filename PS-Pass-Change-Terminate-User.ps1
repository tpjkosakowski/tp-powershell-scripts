...
<#
.SYNOPSIS
  Script to reset a user password on all DCs and Azure or to terminate a user creating a strong password and blocking sign ins.
...
write-host "=================================================================================================`n" -for green

banner -Text "Password Reset / Terminate User" -FontColor Cyan
                                                                                                                                                                                                  
write-host "`n===============================================================================================`n" -for green


Get-RandomPassword 40 5 5 5 5 